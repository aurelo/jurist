...
insert into JU_ZAKONI (id, opis, datum_od, datum_do)
values (4, 'Zakon o financijskom poslovanju i predsteèajnoj nagodbi', to_date('30-06-2013', 'dd-mm-yyyy'), null);
insert into JU_ZAKONI (id, opis, datum_od, datum_do)
...
values (1, 'izraèun za fizièke osobe', 1, 'FZ');
insert into JU_TIPOVI_IZRACUNA (id, naziv, toa_id, sifra)
values (21, 'izraèun za pravne osobe (ZOO)', 2, 'MB-ZOO');
insert into JU_TIPOVI_IZRACUNA (id, naziv, toa_id, sifra)
values (41, 'izraèun za pravne osobe (ZPFFN)', 2, 'MB-ZFPPN');
commit;
prompt 3 records loaded
